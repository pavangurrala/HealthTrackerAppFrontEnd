              ...
              <div class="d-flex align-items-center mb3">
                <form>
                  <div class="row mb-3">
                    ...
                    <div class="col-sm-9">
                      <input type="text" class="form-control" id="id" placeholder="Enter ID" v-model="userData.id" autocomplete="id" disabled>
                    </div>
                  </div>
                  <div class="row mb-3">
                    <label for="name" class="col-sm-3 col-form-label">Name</label>
                    <div class="col-sm-9">
                      <input type="text" class="form-control" id="name" placeholder="Enter the User Name" v-model="userData.name" autocomplete="name" required>
                    </div>
                  </div>
                  <div class="row mb-3">
                    <label for="email" class="col-sm-3 col-form-label">Email</label>
                    <div class="col-sm-9">
                      <input type="text" class="form-control" id="email" placeholder="Enter the User Email" v-model="userData.email" autocomplete="email" required>
                    </div>
                  </div>
                  <div class="row mb-3">
                    <label for="dateofbirth" class="col-sm-3 col-form-label">D.O.B</label>
                    <div class="col-sm-9">
                      <input type="date" class="form-control" id="dateofbirth" placeholder="Enter the User dateofbirth" v-model="userData.dateofbirth" autocomplete="dateofbirth" required>
                    </div>
                  </div>
                </form>
              </div>
